...
//    $(document).'click','.mypopover', function(){
//        $('.editable-buttons').appendTo('<button type="submit" class="btn btn-primary btn-sm editable-button"><i class="glyphicon glyphicon-ok"></i>sdfdf</button>');
//    })
//})
