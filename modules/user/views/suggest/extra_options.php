...
echo $form->field($model,'source_words_count_from')->textInput(['type'=>'number','min'=>1,'max'=>32, 'class'=>'extra_options']);
echo $form->field($model,'source_words_count_to')->textInput(['type'=>'number','min'=>1,'max'=>32, 'class'=>'extra_options']);
